...
from load_graph import load_reddit, inductive_split, load_ogbn_dataset, load_cora, load_karate
...
if __name__=='__main__':
	...
	elif args.dataset in ["ogbn-products", "ogbn-mag","ogbn-papers100M"]:
		data = load_ogbn_dataset(args.dataset, device, args)
