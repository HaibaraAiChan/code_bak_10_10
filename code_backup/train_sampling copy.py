...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num-epochs', type=int, default=26)
    ...
    argparser.add_argument('--log-every', type=int, default=25)
    argparser.add_argument('--eval-every', type=int, default=25)
    ...
    # remove isolated nodes in training graph
