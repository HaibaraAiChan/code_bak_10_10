...
from load_graph import load_reddit, inductive_split, load_cora, load_karate
...
if __name__ == '__main__':
	...
	argparser.add_argument('--num-epochs', type=int, default=21)
	...
	# argparser.add_argument('--full-batch', type=int, default=1000)
