...
from load_graph import load_reddit, inductive_split, load_ogb, load_cora, load_karate, prepare_data, prepare_data_mag, prepare_data_papers100m
...
def main(args):
	...
	if args.dataset=='karate':
		...
		data = prepare_data_papers100m(device, args)
		device = "cuda:0"
